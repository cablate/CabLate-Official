...
export const learningPath = [
  {
    ...
    title: '免費問題診斷',
    outcome: '做完會得到一個最值得處理的卡點，以及下一個可以立刻測的動作；再決定要不要花錢學或換工具。',
    price: '免費',
    href: '/expertise/',
    cta: '先做問題診斷',
  },
  {
    ...
    title: '講座與工作坊',
    outcome: '用示範和實作把關鍵差異講清楚。結束時，個人會知道怎麼開始，團隊也會留下共同的判斷方式。',
    price: null,
  ...
  },
  {
    ...
    outcome: '先拿一個現有任務或 Skill 找出失效點，再把真正有效的判斷、順序與限制留下來。',
    price: 'NT$1,500，一次付費',
  ...
  },
  {
    ...
    outcome: '先用手冊定位一個設定、Context、成本或 Agent 流程問題，再依 CLAUDE.md、Memory、Skill、Hook 與 Harness 的章節逐步排錯。',
    price: 'NT$5,999，一次付費',
...
export const primaryNavigationGroups = [
  ...
  },
  {
    label: '關於',
    items: [
      { label: '電子報', railLabel: '訂閱 CabLate 的電子報', href: '/subscribe/?shell=desk' },
