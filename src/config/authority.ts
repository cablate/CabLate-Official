...
export const learningPath = [
  {
    ...
    title: '免費問題診斷',
    outcome: '先把問題看清楚，再決定值不值得花錢學、換工具，還是其實不用再研究更多。',
    price: '免費',
    href: '/expertise/',
    cta: '先做問題診斷',
  },
  {
    ...
    title: '講座與工作坊',
    outcome: '適合想在一兩個小時內把一個主題弄懂，或讓團隊先有共同基礎。我會用示範和實作把關鍵差異講清楚，不只是把名詞講完。',
    price: null,
  ...
  },
  {
    ...
    outcome: '不是教你再寫更多規則，而是弄懂 Skill 什麼時候有用、為什麼會失效，以及怎麼把真的有效的做法留下來。',
    price: 'NT$1,500，一次付費',
  ...
  },
  {
    ...
    outcome: '已經在用 Claude Code，卻常被設定、Context、成本或 Agent 流程搞到不知道從哪裡查，就把這本當排錯手冊用。CLAUDE.md、Memory、Skill、Hook、Context 與 Harness 都會在裡面拆開說。',
    price: 'NT$5,999，一次付費',
